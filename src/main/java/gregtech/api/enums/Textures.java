...
public class Textures {
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        MACHINE_CASING_RADIATIONPROOF, MACHINE_CASING_FIREBOX_BRONZE, MACHINE_CASING_FIREBOX_STEEL, MACHINE_CASING_FIREBOX_TUNGSTENSTEEL, MACHINE_CASING_ENGINE_INTAKE, MACHINE_CASING_DYSON_RING, MACHINE_CASING_CORE_CHAMBER, MACHINE_COIL_CUPRONICKEL, 
        MACHINE_COIL_KANTHAL, MACHINE_COIL_NICHROME, MACHINE_COIL_TUNGSTENSTEEL, MACHINE_COIL_HSSG, MACHINE_COIL_NAQUADAH, MACHINE_COIL_NAQUADAHALLOY, MACHINE_COIL_MAGNETIC, MACHINE_INTERMIX_CHAMBER, BOILER_SOLAR, BOILER_FRONT, 
